<?php require "header.php"; ?>
 ...
 <div class="container marketing" style="padding-top: 70px;">
  ...
  <h2 class="featurette-heading" style="padding-top: 20px; padding-bottom: 20px;" id="About">Transparência Total.   </span></h2>

<p> Conheça todas as transações financeiras de nossa organização. Saiba para onde vai cada centavo arrecadado. </p>

<hr class="featurette-divider">

<h2 class="featurette-heading" style="padding-top: 20px; padding-bottom: 20px;" id="About">Transações Detalhadas.   </span></h2>
...
<p> Se você quiser auditar todas nossas receitas e despesas. </p>
 ...
 <hr class="featurette-divider">
  ...
  <h2 class="featurette-heading" style="padding-top: 20px; padding-bottom: 20px;" id="About">Resumo Consolidado   </span></h2>
